...
Description: 
	...
	1.05
	-- Remove Metamap support and add TomTom
------------------------------------------------------
Connection:
--]]--------------------------------------------------
...
function objSettingsFrame:new(fParent, tTexture, oSettings)	
	...
	-- Settings Frame
		...
		obj.tWidgets.checkbutton_TomTomSupport = Render_SFTomTomSupportCheckBox(obj.tWidgets.frame_SettingFrame, "VG_SettingsFrame_TomTomCheckButton", tTomTom)
		obj.tWidgets.checkbutton_TomTomSupport:SetPoint("TOPLEFT", obj.tWidgets.frame_SettingFrame, "TOPLEFT", 8, -20)
	...
	obj.tWidgets.checkbutton_TomTomSupport:SetScript("OnClick", function()
		if arg1 == "LeftButton" then
			...
			local tTomTom = oSettings:GetSettingsTomTom()
			if not bVal then
				tTomTom.ArrowEnable = false
			else
				tTomTom.ArrowEnable = true
			end
			oSettings:SetSettingsTomTom(tTomTom)
		end
	end)
