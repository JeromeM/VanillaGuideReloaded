...
-----------1-300 Alchemy
	[7002] = {
		...
		items = {
			...
			[2] = { str = "#DOAprx. Mats Required#: #VIDEO60#x #INPeacebloom# #VIDEO60#x #INSilverleaf# #VIDEO75#x #INEmpty Vial#" ..
				"#VIDEO80#x #INBriarthorn# #VIDEO30#x #INBruiseweed# #VIDEO65#x #INLeaded Vial#" .. 
				"#VIDEO15#x #INMageroyal# #VIDEO40#x #INStranglekelp# #VIDEO30#x #INLiferoot# #VIDEO30#x #INKingsblood#" ..
				"#VIDEO45#x #INGoldthorn# #VIDEO5#x #INSteelbloom# #VIDEO70#x #INSungrass#" ..
				"#VIDEO15#x #INKhadgars Whisker# #VIDEO90#x #INCrystal Vial# #VIDEO20#x #INArthas Tears#" ..
				"#VIDEO40#x #INBlindweed# #VIDEO40#x #INGolden Sansam# #VIDEO40#x #INMountain Silversage#" },
...
-----------1-300 Blacksmithing
	[7003] = {
		...
		items = {
			...
			[2] = { str = "#DOAprx. Mats Required#: #VIDEO90#x #INRough Stone# #VIDEO380#x #INCopper Bar# #VIDEO20#x #INCoarse Stone# " ..
				"#VIDEO5#x #INSilver Bar# #VIDEO120#x #INBronze Bar# #VIDEO150#x #INHeavy Stone# " ..
				"#VIDEO5#x #INGold Bar# #VIDEO200#x #INIron Bar# #VIDEO30#x #INGreen Dye# " ..
				"#VIDEO380#x #INSteel Bar# #VIDEO80#x #INSolid Stone# #VIDEO230#x #INMithril Bar# " ..
				"#VIDEO20#x #INDense Stone# #VIDEO430#x #INThorium Bar# #VIDEO10#x #INCore of Earth# " ..
				"#VIDEO90#x #INMageweave Cloth# #VIDEO60#x #INRugged Leather#" },
...
-----------1-300 Enchanting
	[7006] = {
		...
		items = {
			...
			"#VIDEO150#x #INStrange Dust# #VIDEO90#x #INSoul Dust# #VIDEO170#x #INVision Dust# " .. 
			"#VIDEO300#x #INDream Dust# #VIDEO90#x #INIllusion Dust# #VIDEO15#x #INSimple Wood# " .. 
			"#VIDEO15#x #INLesser Magic Essence# #VIDEO25#x #INGreater Magic Essence# #VIDEO15#x #INLesser Astral Essence# " .. 
			"#VIDEO2#x #INGreater Astral Essence# #VIDEO25#x #INLesser Mystic Essence# #VIDEO2#x #INGreater Mystic Essence# " .. 
			"#VIDEO15#x #INLesser Nether Essence# #VIDEO10#x #INGreater Nether Essence# #VIDEO40#x #INPurple Lotus# " .. 
			"#VIDEO20#x #INCrystal Vial# #VIDEO4x# #INGreater Eternal Essence# #VIDEO2#x #INLarge Brilliant Shard# " .. 
			"#VIDEO1#x #INShadowgem# #VIDEO1x# #INIridescent Pearl# #VIDEO1#x #INBlack Pearl# " .. 
			"#VIDEO1#x #INGolden Pearl# #VIDEO1x# #INCopper Rod# #VIDEO1#x #INSilver Rod# " .. 
			"#VIDEO1#x #INGolden Rod# #VIDEO1#x #INTruesilver Rod# #VIDEO1#x #INArcanite Rod#" },
...
-----------1-300 Engineering
	[7007] = {
		...
		items = {
			...
			[2] = { str = "#DOAprx. Mats Required#: " .. 
			"#VIDEO90#x #INRough Stone# #VIDEO80#x #INCoarse Stone# #VIDEO75#x #INHeavy Stone# " .. 
			"#VIDEO90#x #INSolid Stone# #VIDEO50#x #INDense Stone# #VIDEO10#x #INWooden Stock# " .. 
			"#VIDEO29#x #INWeak Flux# #VIDEO50#x #INHeavy Leather# #VIDEO10#x #INWool Cloth# " .. 
			"#VIDEO10#x #INMageweave Cloth# #VIDEO33#x #INRune Cloth# #VIDEO51#x #INCopper Bars# " .. 
			"#VIDEO10#x #INSilver Bars# #VIDEO55#x #INBronze Bars# #VIDEO19#x #INIron Bars# " .. 
			"#VIDEO4#x #INSteel Bars# #VIDEO126#x #INMithril Bars# #VIDEO129#x #INThorium Bars#" },
...
-----------1-300 Leatherworking
	[7008] = {
		...
		items = {
			...
			"#VIDEO275#x #INLight Leather# #VIDEO20#x #INLight Hide# #VIDEO25#x #INMedium Hide# " .. 
			"#VIDEO420#x #INHeavy Leather# #VIDEO10#x #INHeavy Hide# #VIDEO30#x #INBolt of Silk Cloth# " .. 
			"#VIDEO10#x #INIron Buckles#" },
			...
			[16] = { str = "#VIDEO[205-250]# #DOAprx. Mats Required#:                                            " .. 
				"#GETElemental Leatherworking#: #VIDEO405-455#x #INThick Leather#                                            " .. 
				"#GETDragonscale Leatherworking:# #VIDEO441-483#x #INThick Leather# #VIDEO40#x #INScorpid Scale# #VIDEO10#x #INWorn Dragonscale#                                            " .. 
				"#GETTribal Leatherworking#: #VIDEO427-449#x #INThick Leather# #VIDEO112#x #INurtle Scale# #VIDEO11#x #INWildvine# #VIDEO2#x #INCured Thick Hide#" },
			...
			[32] = { str = "#VIDEO[250-300]# #DOAprx. Mats Required#: #VIDEO160#x #INThick Leather# #VIDEO470#x #INRugged Leather#" },
...
-----------1-300 Tailoring
	[7009] = {
		...
		items = {
			...
			[2] = { str = "#DOAprx. Mats Required#: #VIDEO160#x #INLinen Cloth# #VIDEO200#x #INWool Cloth# #VIDEO760#x #INSilk Cloth# " .. 
			"#VIDEO520#x #INMageweave Cloth# #VIDEO900#x #INRunecloth# #VIDEO120#x #INRugged Leather# " .. 
			"#VIDEO75#x #INCoarse Thread# #VIDEO135#x #INFine Thread# #VIDEO5#x #INGray Dye# " .. 
			"#VIDEO30#x #INBlue Dye# #VIDEO10#x #INBleach# #VIDEO60#x #INRed Dye# " .. 
			"#VIDEO45#x #INSilken Thread# #VIDEO60#x #INHeavy Silken Thread# #VIDEO40#x #INRune Thread#" },
