...
-----------12-15 Barrens
	...
	[1215] = {
		...
		items = {
			...
			[3] = { str = "Then turn in #INAk'Zeloth# #COORD[62,20]# if you have it, SKIP #SKIPThe Demon Seed# ", x = 62, y = 20, zone = "The Barrens" },
			[4] = { str = "Run to Crossroads at #COORD[52,30]#.", x = 52, y = 30, zone = "The Barrens" },
			[5] = { str = "^-'" },
